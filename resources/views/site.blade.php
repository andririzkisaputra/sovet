...
<body>
    <div class="container col-12 mb-5">
        ...
        <div class="our-event pt-5 mt-5">
            ...
            <div class="grid-container">
                <img src="{{ url('img/events/event-1.jpg') }}" class="w-100 shadow filter 17-agustus"
                    alt="{{ url('/') }}">
                <img src="{{ url('img/events/event-2.jpg') }}" class="w-100 shadow filter 17-agustus"
                    alt="{{ url('/') }}">
                <img src="{{ url('img/events/event-3.jpg') }}" class="w-100 shadow filter 17-agustus"
                    alt="{{ url('/') }}">
            </div>
        </div>
        ...
        <div class="our-client pt-5 mt-5">
            ...
            <section class="customer-logos slider">
                ...
                <img class="slide" src="{{ url('img/client/perkebunan-nusantara.png') }}"
                    alt="{{ url('/') }}">
            </section>
        </div>
        ...
        <div class="board-of-directors pt-5 mt-5">
            ...
            <div class="row text-center">
                <div class="col-lg-3 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                    data-wow-offset="0"
                    style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="our-team">
                        <div class="single-team">
                            <img src="{{ url('img/stephan-mario-untu.png') }}" class="img-fluid"
                                alt="{{ url('/') }}">
                ...
                <div class="col-lg-3 col-sm-12 col-xs-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"
                    ...
                    <div class="our-team">
                        <div class="single-team">
                            <img src="{{ url('img/yilia-restuaji.png') }}" class="img-fluid"
                                alt="{{ url('/') }}">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-5">
                        ...
                        <p>
                            ...
                            <a style="color: #000; text-decoration: none;" href="https://wa.me/628170708008"
                                target="_blank">081-7070-8008</a>
                        </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-4 col-lg-8 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <p>
                            ...
                            Jl. Rumah Sakit Ubud, Terace Campus I Private Residence No. 4 Jimbaran, Kuta Selatan,
                            Badung, <strong>Bali</strong>
                        </p>
                    </div>
                    <!-- Grid column -->
                </div>
    ...
    <a href="http://" target="_blank" rel="noopener noreferrer">
        <img src="{{ url('img/whatsapp.gif') }}" alt="{{ route('site') }}"
            style="width: 75px; position: fixed; bottom: 15px; right: 15px;">
    </a>
</body>
