...
<head>
    ...
    <meta name="description"
        content="{{ ENV('APP_NAME') }}, Event Organizer, Organizer, Production, Media Management" />
    <meta name="keywords" content="{{ ENV('APP_NAME') }} , Event Organizer, Organizer, Production, Media Management" />
